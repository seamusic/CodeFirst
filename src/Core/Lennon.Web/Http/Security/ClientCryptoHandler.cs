...
using Lennon.Web.Http.Handlers;
...
namespace Lennon.Web.Http.Security
{
    ...
    public class ClientCryptoHandler : DelegatingHandler
    {
        ...
        {
            request.Headers.Add(HttpHeaderNames.GmfClientPublicKey, _clientPublicKey);
        ...
        private HttpResponseMessage DecryptResponse(HttpResponseMessage response)
        {
            ...
            catch (Exception ex)
            {
                ...
                response.ReasonPhrase = Resources.Http_Seciruty_Client_DecryptResponse_Failt + ex.Message;
